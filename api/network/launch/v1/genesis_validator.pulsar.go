...
var (
	...
	fd_GenesisValidator_launchID       protoreflect.FieldDescriptor
	fd_GenesisValidator_address        protoreflect.FieldDescriptor
	fd_GenesisValidator_genTx          protoreflect.FieldDescriptor
	fd_GenesisValidator_consPubKey     protoreflect.FieldDescriptor
...
func init() {
	...
	fd_GenesisValidator_launchID = md_GenesisValidator.Fields().ByName("launchID")
	fd_GenesisValidator_address = md_GenesisValidator.Fields().ByName("address")
	fd_GenesisValidator_genTx = md_GenesisValidator.Fields().ByName("genTx")
	fd_GenesisValidator_consPubKey = md_GenesisValidator.Fields().ByName("consPubKey")
...
func (x *fastReflection_GenesisValidator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.LaunchID != uint64(0) {
		...
		if !f(fd_GenesisValidator_launchID, value) {
			return
		}
	}
	if x.Address != "" {
	...
	if len(x.GenTx) != 0 {
		...
		if !f(fd_GenesisValidator_genTx, value) {
			return
		}
	}
	if len(x.ConsPubKey) != 0 {
		value := protoreflect.ValueOfBytes(x.ConsPubKey)
		if !f(fd_GenesisValidator_consPubKey, value) {
			return
		}
	}
...
func (x *fastReflection_GenesisValidator) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "network.launch.v1.GenesisValidator.launchID":
		return x.LaunchID != uint64(0)
	case "network.launch.v1.GenesisValidator.address":
		return x.Address != ""
	case "network.launch.v1.GenesisValidator.genTx":
		return len(x.GenTx) != 0
	case "network.launch.v1.GenesisValidator.consPubKey":
...
func (x *fastReflection_GenesisValidator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "network.launch.v1.GenesisValidator.launchID":
		panic(fmt.Errorf("field launchID of message network.launch.v1.GenesisValidator is not mutable"))
	case "network.launch.v1.GenesisValidator.address":
		panic(fmt.Errorf("field address of message network.launch.v1.GenesisValidator is not mutable"))
	case "network.launch.v1.GenesisValidator.genTx":
		panic(fmt.Errorf("field genTx of message network.launch.v1.GenesisValidator is not mutable"))
	case "network.launch.v1.GenesisValidator.consPubKey":
		panic(fmt.Errorf("field consPubKey of message network.launch.v1.GenesisValidator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: network.launch.v1.GenesisValidator"))
		}
...
var (
	...
	fd_Peer_tcpAddress protoreflect.FieldDescriptor
	fd_Peer_httpTunnel protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Peer_tcpAddress = md_Peer.Fields().ByName("tcpAddress")
...
func (x *fastReflection_Peer) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Connection != nil {
		...
		case *Peer_TcpAddress:
			...
			if !f(fd_Peer_tcpAddress, value) {
				return
			}
		case *Peer_HttpTunnel:
			v := o.HttpTunnel
			value := protoreflect.ValueOfMessage(v.ProtoReflect())
			if !f(fd_Peer_httpTunnel, value) {
				return
			}
		case *Peer_None:
			v := o.None
...
func (x *fastReflection_Peer) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "network.launch.v1.Peer.id":
		return x.Id != ""
	case "network.launch.v1.Peer.tcpAddress":
		if x.Connection == nil {
			return false
	...
	case "network.launch.v1.Peer.httpTunnel":
		if x.Connection == nil {
			return false
...
func (x *fastReflection_Peer) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "network.launch.v1.Peer.tcpAddress":
		panic(fmt.Errorf("field tcpAddress of message network.launch.v1.Peer is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: network.launch.v1.Peer"))
		}
...
func (x *fastReflection_Peer) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	...
	case "network.launch.v1.Peer.connection":
		...
		case *Peer_TcpAddress:
			return x.Descriptor().Fields().ByName("tcpAddress")
		case *Peer_HttpTunnel:
			return x.Descriptor().Fields().ByName("httpTunnel")
		case *Peer_None:
...
type Peer_TcpAddress struct {
	TcpAddress string `protobuf:"bytes,2,opt,name=tcpAddress,proto3,oneof"` // use a TCP address
}

type Peer_HttpTunnel struct {
	HttpTunnel *Peer_HTTPTunnel `protobuf:"bytes,3,opt,name=httpTunnel,proto3,oneof"` // or use an HTTP tunnel
}
...
var file_network_launch_v1_genesis_validator_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_network_launch_v1_genesis_validator_proto_depIdxs = []int32{
	...
	2, // 2: network.launch.v1.Peer.httpTunnel:type_name -> network.launch.v1.Peer.HTTPTunnel
