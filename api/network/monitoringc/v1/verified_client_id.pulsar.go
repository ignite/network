...
var _ protoreflect.List = (*_VerifiedClientID_2_list)(nil)

type _VerifiedClientID_2_list struct {
	list *[]string
}

func (x *_VerifiedClientID_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_VerifiedClientID_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_VerifiedClientID_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_VerifiedClientID_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
...
func (x *_VerifiedClientID_2_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_VerifiedClientID_2_list) IsValid() bool {
	return x.list != nil
}
...
type fastReflection_VerifiedClientID VerifiedClientID

func (x *VerifiedClientID) ProtoReflect() protoreflect.Message {
	return (*fastReflection_VerifiedClientID)(x)
}

func (x *VerifiedClientID) slowProtoReflect() protoreflect.Message {
	mi := &file_network_monitoringc_v1_verified_client_id_proto_msgTypes[0]
...
var _fastReflection_VerifiedClientID_messageType fastReflection_VerifiedClientID_messageType
var _ protoreflect.MessageType = fastReflection_VerifiedClientID_messageType{}

type fastReflection_VerifiedClientID_messageType struct{}

func (x fastReflection_VerifiedClientID_messageType) Zero() protoreflect.Message {
	return (*fastReflection_VerifiedClientID)(nil)
}
func (x fastReflection_VerifiedClientID_messageType) New() protoreflect.Message {
	return new(fastReflection_VerifiedClientID)
}
func (x fastReflection_VerifiedClientID_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_VerifiedClientID
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_VerifiedClientID) Descriptor() protoreflect.MessageDescriptor {
	return md_VerifiedClientID
}
...
func (x *fastReflection_VerifiedClientID) Type() protoreflect.MessageType {
	return _fastReflection_VerifiedClientID_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_VerifiedClientID) New() protoreflect.Message {
	return new(fastReflection_VerifiedClientID)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_VerifiedClientID) Interface() protoreflect.ProtoMessage {
	return (*VerifiedClientID)(x)
}
...
func (x *fastReflection_VerifiedClientID) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message network.monitoringc.v1.VerifiedClientID does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_VerifiedClientID) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message network.monitoringc.v1.VerifiedClientID does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_VerifiedClientID) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in network.monitoringc.v1.VerifiedClientID", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_VerifiedClientID) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_VerifiedClientID) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_VerifiedClientID) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_VerifiedClientID) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*VerifiedClientID)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: VerifiedClientID: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: VerifiedClientID: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *VerifiedClientID) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifiedClientID) ProtoMessage() {}

// Deprecated: Use VerifiedClientID.ProtoReflect.Descriptor instead.
...
var File_network_monitoringc_v1_verified_client_id_proto protoreflect.FileDescriptor

var file_network_monitoringc_v1_verified_client_id_proto_rawDesc = []byte{
...
var (
	file_network_monitoringc_v1_verified_client_id_proto_rawDescOnce sync.Once
	file_network_monitoringc_v1_verified_client_id_proto_rawDescData = file_network_monitoringc_v1_verified_client_id_proto_rawDesc
)

func file_network_monitoringc_v1_verified_client_id_proto_rawDescGZIP() []byte {
	file_network_monitoringc_v1_verified_client_id_proto_rawDescOnce.Do(func() {
		file_network_monitoringc_v1_verified_client_id_proto_rawDescData = protoimpl.X.CompressGZIP(file_network_monitoringc_v1_verified_client_id_proto_rawDescData)
	})
	return file_network_monitoringc_v1_verified_client_id_proto_rawDescData
}

var file_network_monitoringc_v1_verified_client_id_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_network_monitoringc_v1_verified_client_id_proto_goTypes = []interface{}{
	(*VerifiedClientID)(nil), // 0: network.monitoringc.v1.VerifiedClientID
}
var file_network_monitoringc_v1_verified_client_id_proto_depIdxs = []int32{
...
func init() { file_network_monitoringc_v1_verified_client_id_proto_init() }
func file_network_monitoringc_v1_verified_client_id_proto_init() {
	if File_network_monitoringc_v1_verified_client_id_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_network_monitoringc_v1_verified_client_id_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VerifiedClientID); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_network_monitoringc_v1_verified_client_id_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_network_monitoringc_v1_verified_client_id_proto_goTypes,
	...
	File_network_monitoringc_v1_verified_client_id_proto = out.File
	file_network_monitoringc_v1_verified_client_id_proto_rawDesc = nil
	file_network_monitoringc_v1_verified_client_id_proto_goTypes = nil
	file_network_monitoringc_v1_verified_client_id_proto_depIdxs = nil
}
