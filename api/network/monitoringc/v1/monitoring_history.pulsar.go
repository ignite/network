...
var (
	...
	fd_MonitoringHistory_launchID               protoreflect.FieldDescriptor
	fd_MonitoringHistory_latestMonitoringPacket protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MonitoringHistory_launchID = md_MonitoringHistory.Fields().ByName("launchID")
	fd_MonitoringHistory_latestMonitoringPacket = md_MonitoringHistory.Fields().ByName("latestMonitoringPacket")
}
...
func (x *fastReflection_MonitoringHistory) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.LaunchID != uint64(0) {
		...
		if !f(fd_MonitoringHistory_launchID, value) {
			return
		}
	}
	if x.LatestMonitoringPacket != "" {
		value := protoreflect.ValueOfString(x.LatestMonitoringPacket)
		if !f(fd_MonitoringHistory_latestMonitoringPacket, value) {
			return
		}
	}
}
...
func (x *fastReflection_MonitoringHistory) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "network.monitoringc.v1.MonitoringHistory.launchID":
		return x.LaunchID != uint64(0)
	case "network.monitoringc.v1.MonitoringHistory.latestMonitoringPacket":
...
func (x *fastReflection_MonitoringHistory) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "network.monitoringc.v1.MonitoringHistory.latestMonitoringPacket":
		x.LatestMonitoringPacket = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: network.monitoringc.v1.MonitoringHistory"))
		}
...
func (x *fastReflection_MonitoringHistory) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "network.monitoringc.v1.MonitoringHistory.launchID":
		panic(fmt.Errorf("field launchID of message network.monitoringc.v1.MonitoringHistory is not mutable"))
	case "network.monitoringc.v1.MonitoringHistory.latestMonitoringPacket":
		panic(fmt.Errorf("field latestMonitoringPacket of message network.monitoringc.v1.MonitoringHistory is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: network.monitoringc.v1.MonitoringHistory"))
		}
...
func (x *fastReflection_MonitoringHistory) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.LatestMonitoringPacket)
		if l > 0 {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.LatestMonitoringPacket) > 0 {
			i -= len(x.LatestMonitoringPacket)
			copy(dAtA[i:], x.LatestMonitoringPacket)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.LatestMonitoringPacket)))
			i--
			dAtA[i] = 0x12
		}
		if x.LaunchID != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.LatestMonitoringPacket = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *MonitoringHistory) GetLatestMonitoringPacket() string {
	if x != nil {
		return x.LatestMonitoringPacket
	}
	return ""
...
var file_network_monitoringc_v1_monitoring_history_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x6b, 0x2f, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x63, 0x2f, 0x76,
	0x31, 0x3b, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x63, 0x76, 0x31, 0xa2,
	0x02, 0x03, 0x4e, 0x4d, 0x58, 0xaa, 0x02, 0x16, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e,
	0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x63, 0x2e, 0x56, 0x31, 0xca, 0x02,
	0x16, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5c, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72,
	0x69, 0x6e, 0x67, 0x63, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x22, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	...
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x3a, 0x3a, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x69,
	0x6e, 0x67, 0x63, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
