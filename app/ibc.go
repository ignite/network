...
import (
	...
	monitoringcmodule "github.com/ignite/network/x/monitoringc/module"
	monitoringcmoduletypes "github.com/ignite/network/x/monitoringc/types"
	monitoringpmodule "github.com/ignite/network/x/monitoringp/module"
...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	monitoringcIBCModule := ibcfee.NewIBCMiddleware(monitoringcmodule.NewIBCModule(app.MonitoringcKeeper), app.IBCFeeKeeper)
	ibcRouter.AddRoute(monitoringcmoduletypes.ModuleName, monitoringcIBCModule)
	monitoringpIBCModule := ibcfee.NewIBCMiddleware(monitoringpmodule.NewIBCModule(app.MonitoringpKeeper), app.IBCFeeKeeper)
	ibcRouter.AddRoute(monitoringpmoduletypes.ModuleName, monitoringpIBCModule)
