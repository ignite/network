...
import (
	...
	modulev1 "github.com/ignite/network/api/network/launch/module/v1"
	"github.com/ignite/network/x/launch/client/cli"
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{LaunchKeeper: k, Module: m}
}

func InvokeSetHooks(keeper *keeper.Keeper, hooks map[string]types.LaunchHooks) error {
	...
	var multiHooks types.MultiLaunchHooks
