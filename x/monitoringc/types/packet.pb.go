...
func (*MonitoringcPacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_6470c5bfb245f643, []int{0}
}
...
func (m *MonitoringcPacketData) GetNoData() *NoData {
	if x, ok := m.GetPacket().(*MonitoringcPacketData_NoData); ok {
		return x.NoData
	}
	return nil
}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return fileDescriptor_6470c5bfb245f643, []int{1}
}
...
func init() {
	proto.RegisterType((*MonitoringcPacketData)(nil), "network.monitoringc.v1.MonitoringcPacketData")
	proto.RegisterType((*NoData)(nil), "network.monitoringc.v1.NoData")
}

func init() {
	proto.RegisterFile("network/monitoringc/v1/packet.proto", fileDescriptor_6470c5bfb245f643)
}

var fileDescriptor_6470c5bfb245f643 = []byte{
	...
	0x00, 0x00, 0x00, 0xff, 0xff, 0xdf, 0x3a, 0x50, 0x64, 0xf5, 0x00, 0x00, 0x00,
}
...
func (m *MonitoringcPacketData_NoData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MonitoringcPacketData_NoData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.NoData != nil {
		{
...
func (m *MonitoringcPacketData_NoData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MonitoringcPacketData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Packet = &MonitoringcPacketData_NoData{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
