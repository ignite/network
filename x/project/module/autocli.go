		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "project_name"}, {ProtoField: "total_supply"}, {ProtoField: "metadata"}},
				},
				{
					RpcMethod:      "EditProject",
					Use:            "edit-project [project-id] [name] [metadata]",
					Short:          "Send a EditProject tx",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "project_id"}, {ProtoField: "name"}, {ProtoField: "metadata"}},
				},
				{
				...
				},
				{
					...
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{{ProtoField: "project_id"}, {ProtoField: "account"}, {ProtoField: "vouchers"}},
				},
				{
