...
func (*ShareVestingOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_5db7ebf41d291562, []int{0}
}
...
type ShareVestingOptions_DelayedVesting struct {
	DelayedVesting *ShareDelayedVesting `protobuf:"bytes,1,opt,name=delayed_vesting,json=delayedVesting,proto3,oneof" json:"delayed_vesting,omitempty"`
}
...
type ShareDelayedVesting struct {
	TotalShares Shares    `protobuf:"bytes,1,rep,name=total_shares,json=totalShares,proto3,casttype=github.com/cosmos/cosmos-sdk/types.Coin,castrepeated=Shares" json:"total_shares"`
...
func (*ShareDelayedVesting) Descriptor() ([]byte, []int) {
	return fileDescriptor_5db7ebf41d291562, []int{1}
}
...
func init() {
	proto.RegisterType((*ShareVestingOptions)(nil), "network.project.v1.ShareVestingOptions")
	proto.RegisterType((*ShareDelayedVesting)(nil), "network.project.v1.ShareDelayedVesting")
}

func init() { proto.RegisterFile("network/project/v1/vesting.proto", fileDescriptor_5db7ebf41d291562) }

var fileDescriptor_5db7ebf41d291562 = []byte{
	// 433 bytes of a gzipped FileDescriptorProto
	,
}
